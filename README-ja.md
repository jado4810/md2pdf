...
```console
$ ./md2pdf.sh [オ̲プ̲シ̲ョ̲ン̲] [入̲力̲フ̲ァ̲イ̲ル̲] > 出̲力̲フ̲ァ̲イ̲ル̲
```
...
```console
$ docker run --rm -i -v ベ̲ー̲ス̲デ̲ィ̲レ̲ク̲ト̲リ̲ー̲:/opt/app/mnt md2pdf node md2pdf.js -b /opt/app/mnt オ̲プ̲シ̲ョ̲ン̲ 入̲力̲フ̲ァ̲イ̲ル̲
```
...
```console
$ node md2pdf.js [オ̲プ̲シ̲ョ̲ン̲] [入̲力̲フ̲ァ̲イ̲ル̲] > 出̲力̲フ̲ァ̲イ̲ル̲
```
