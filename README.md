...
>
> Also, now `blockquote` and `pre` have been made to be placed inside `figure` element so that the backgrounds of the quotes or code blocks would not overflow under floated images.
> **(CHANGED ON VER.0.13)**
>
...
Provided under [MIT license](./LICENSE.txt).
